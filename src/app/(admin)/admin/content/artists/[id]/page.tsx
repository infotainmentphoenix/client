  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black tracking-tight">Edit Artist</h1>
          <p className="text-gray-500">Update the details for this artist profile.</p>
        </div>
      </div>

      <ArtistForm artistId={resolvedParams.id} />
    </div>
  );
}
