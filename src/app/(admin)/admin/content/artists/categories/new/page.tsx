...
export default function NewArtistCategoryPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black tracking-tight">Add Artist Category</h1>
          <p className="text-gray-500">Create a new category for classifying your artists.</p>
        </div>
      </div>
