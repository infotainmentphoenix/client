...
export default function EditPageSettingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black tracking-tight">Edit Content Block</h1>
          <p className="text-gray-500">Update the value of this site setting.</p>
        </div>
      </div>

      <PageForm settingId={resolvedParams.id} />
    </div>
  );
}
