...
export default function AuthLayout({
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden pt-20">
        ...
        {/* Auth card container */}
        <div className="relative z-10 w-full max-w-md px-4 mt-8 mb-8">
          {children}
        </div>
      </div>
    </>
