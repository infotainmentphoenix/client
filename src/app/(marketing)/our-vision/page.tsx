    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans transition-colors duration-300">
      ...
      <section className="relative w-full min-h-[85vh] flex items-center justify-center pt-36 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 text-center max-w-5xl">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 text-orange-400 font-bold text-xs tracking-[0.25em] uppercase">
          ...
          <div className="max-w-4xl mx-auto relative group">
            ...
            <div className="relative bg-[#0b0b0b] border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl">
              <p className="text-xl md:text-3xl text-gray-100 font-light leading-relaxed italic">
      ...
      {}
      <section className="container mx-auto px-6 md:px-12 py-24 border-t border-white/5 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-widest text-orange-400 block mb-2">Core Foundations</span>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white">Vision & Mission</h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {}
          <div className="relative group rounded-3xl overflow-hidden bg-white/5 border border-white/10 p-8 md:p-12 backdrop-blur-sm transition-all duration-300 hover:border-orange-500/50 hover:bg-white/[0.07] flex flex-col justify-between">
            ...
            <div className="space-y-6">
              <div className="w-12 h-12 rounded-2xl bg-orange-500/10 text-orange-400 flex items-center justify-center font-black text-xl">
                👁️
              </div>
              <h3 className="text-2xl md:text-3xl font-extrabold text-white">Our Vision</h3>
            ...
            <div className="mt-8 pt-4 border-t border-white/5 text-xs text-orange-400 font-bold uppercase tracking-widest">
              Limitless Creativity
            </div>
          </div>

          {}
          <div className="relative group rounded-3xl overflow-hidden bg-white/5 border border-white/10 p-8 md:p-12 backdrop-blur-sm transition-all duration-300 hover:border-purple-500/50 hover:bg-white/[0.07] flex flex-col justify-between">
            ...
            <div className="space-y-6">
              <div className="w-12 h-12 rounded-2xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-black text-xl">
                🎯
              </div>
              <h3 className="text-2xl md:text-3xl font-extrabold text-white">Our Mission</h3>
              <p className="text-gray-300 font-light leading-relaxed text-base">
            ...
            <div className="mt-8 pt-4 border-t border-white/5 text-xs text-purple-400 font-bold uppercase tracking-widest">
              Flawless Execution
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 md:px-12 py-24 border-t border-white/5 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-widest text-orange-400 block mb-2">Driving Forces</span>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-4">What Drives Our Vision</h2>
          <p className="text-gray-400 text-sm md:text-base font-light max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {}
          <div className="p-8 bg-white/5 border border-white/10 rounded-2xl flex flex-col justify-between hover:border-orange-500/40 transition-all duration-300 hover:translate-y-[-4px] relative group">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 text-orange-400 flex items-center justify-center">
                <SparklesIcon className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-white group-hover:text-orange-400 transition-colors">Creative Excellence</h3>
          ...
          {}
          <div className="p-8 bg-white/5 border border-white/10 rounded-2xl flex flex-col justify-between hover:border-rose-500/40 transition-all duration-300 hover:translate-y-[-4px] relative group">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-rose-500/10 text-rose-400 flex items-center justify-center">
                <UsersIcon className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-white group-hover:text-rose-400 transition-colors">Bridging Art & Audiences</h3>
              <p className="text-gray-400 text-sm leading-relaxed font-light">
          ...
          {}
          <div className="p-8 bg-white/5 border border-white/10 rounded-2xl flex flex-col justify-between hover:border-purple-500/40 transition-all duration-300 hover:translate-y-[-4px] relative group">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center">
                <ShieldCheckIcon className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors">Flawless Execution</h3>
              <p className="text-gray-400 text-sm leading-relaxed font-light">
          ...
          {}
          <div className="p-8 bg-white/5 border border-white/10 rounded-2xl flex flex-col justify-between hover:border-blue-500/40 transition-all duration-300 hover:translate-y-[-4px] relative group">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 text-blue-400 flex items-center justify-center">
                <GlobeIcon className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">Global Reach, Personal Touch</h3>
              <p className="text-gray-400 text-sm leading-relaxed font-light">
      ...
      {}
      <section className="container mx-auto px-6 md:px-12 py-24 border-t border-white/5 relative z-10">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-white/5 to-white/[0.01] border border-white/10 rounded-3xl p-8 md:p-16 backdrop-blur-md relative overflow-hidden">
          {}
          ...
          <div className="relative z-10 text-center space-y-8">
            <span className="text-xs font-bold uppercase tracking-widest text-orange-400">About Phoenix Infotainment</span>
            <h3 className="text-3xl md:text-5xl font-black tracking-tight leading-tight">
              Redefining Celebrations Worldwide
            </h3>
            
            <p className="text-gray-300 font-light leading-relaxed text-lg max-w-3xl mx-auto">
            ...
            <div className="pt-6 flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <Link
                href="/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/5 hover:bg-white/10 text-white border border-white/10 font-bold rounded-full transition-all hover:scale-105"
              >
                Get in Touch
              </Link>
            </div>
