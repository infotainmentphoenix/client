    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#050505] text-gray-900 dark:text-white font-sans transition-colors duration-300">
      ...
      <section className="relative w-full min-h-[55vh] flex items-center justify-center pt-36 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 backdrop-blur-md mb-6 text-orange-600 dark:text-orange-400 font-bold text-xs tracking-[0.2em] uppercase">
            About Us
          </span>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.15] mb-8 text-gray-900 dark:text-white">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-gray-600 dark:text-gray-300 text-lg md:text-xl font-light leading-relaxed">
            <p>
      ...
      <section className="container mx-auto px-6 md:px-12 py-20 border-t border-black/5 dark:border-white/5 relative z-10">
        <div className="max-w-5xl mx-auto bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-xl dark:shadow-none rounded-3xl p-8 md:p-12 backdrop-blur-sm relative overflow-hidden transition-all duration-300">
          {/* Subtle decoration */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* Key Highlights */}
              <div className="pt-4 border-t border-black/10 dark:border-white/10 grid grid-cols-2 gap-4">
                {[
                  'TV Industry Exp.',
                  'Artist Network',
                  'Creative Vision',
                  ...
                  <div key={idx} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-orange-500/10 text-orange-600 dark:text-orange-400 flex items-center justify-center shrink-0">
      ...
      {/* Operations/Departments Section */}
      <section className="container mx-auto px-6 md:px-12 py-20 border-t border-black/5 dark:border-white/5 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-widest text-orange-600 dark:text-orange-400 block mb-2">Our Operations</span>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-2">The Powerhouse</h2>
          <p className="text-lg text-gray-500 dark:text-gray-400 font-light uppercase tracking-wider">Our Departments</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-8 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl flex flex-col justify-between hover:border-orange-500/50 dark:hover:border-orange-500/50 transition-all duration-300 relative group shadow-lg dark:shadow-none">
            ...
            <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5">
              <ul className="space-y-2.5 text-xs text-gray-600 dark:text-gray-300 font-light">
                {[
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-6 md:px-12 py-20 border-t border-black/5 dark:border-white/5 relative z-10 text-center">
