type ConsultationsFilterProps = {
  activeFilter: string;
  setActiveFilter: (filter: string) => void;
  totalCount: number;
};

export function ConsultationsFilter({ activeFilter, setActiveFilter, totalCount }: ConsultationsFilterProps) {
  const tabs = [
    { id: 'ALL', label: `All Sessions (${totalCount})` },
